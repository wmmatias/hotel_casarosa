...
<?php	                }
?>                        <form action="/reservations/arrived/<?=$arrived['id']?>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="adult" id="adult" min="0" value="<?=$arrived['adult']?>" placeholder="Adult" value="" >
                                    <?php echo form_error('adult') ?>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="children" class="form-label">Children</label>
                                    <input type="number" class="form-control" name="children" id="children" min="0" value="<?=$arrived['children']?>" placeholder="phone" value="" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="person" id="person" min="0" value="<?=$arrived['x_person']?>"placeholder="Person" value="" >
                                    <?php echo form_error('person') ?>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="bfast" class="form-label">Extra Breakfast</label>
                                    <input type="number" class="form-control" name="bfast" id="bfast" min="0" value="<?=$arrived['x_bfast']?>"placeholder="Breakfast" value="" >
                            ...
                            <div class="col-md">
                                    ...
                                    <button class="btn btn-success w-100 mb-3">Check In</button>
                            </div>
                        </form>
                </div>
            </div>
